...
const int32_t inertial_port = PORT2;
...
const motor_settings right_front { PORT10, gearSetting::ratio6_1, false };
const motor_settings right_back  { PORT9 , gearSetting::ratio6_1, false };
const motor_settings right_top   { PORT8 , gearSetting::ratio6_1, false  };

const motor_settings lifts   { PORT5 , gearSetting::ratio36_1, false };
...
constexpr double lift_back   = -1.0;
constexpr double lift_center =  0.0;
constexpr double lift_front  =  1.0;
